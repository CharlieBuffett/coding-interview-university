# Chalie' first forked github project


## trying to type a new section
...
### 3. do coding interview books and website question when learning is progressing 

### 4. Focus - maybe try lofi music
...
- You just need to understand how to express the complexity of an algorithm in terms of Big-O.  finnished:) i understand big O now.
- [ ] [Harvard CS50 - Asymptotic Notation (video)](https://www.youtube.com/watch?v=iOq5kSKqeR4) finnished:)
- [ ] [Big O Notations (general quick tutorial) (video)](https://www.youtube.com/watch?v=V6mKVRU1evU) finished:)
- [ ] [Big O Notation (and Omega and Theta) - best mathematical explanation (video)](https://www.youtube.com/watch?v=ei-A_wy5Yxw&index=2&list=PL1BaGV1cIH4UhkL8a9bJGG356covJ76qN)finnished:)
- [ ] [Skiena (video)](https://www.youtube.com/watch?v=z1mkCe3kVUA)finnished:)
- [ ] [UC Berkeley Big O (video)](https://archive.org/details/ucberkeley_webcast_VIS4YDpuP98)finnished:)
